...
import { collectRepoReport } from "../src/lib/github/report-repo"
...
(async () => {
  ...
  const data = await collectRepoReport(org, "WaterlooStar", { since: since.toISOString(), until: now.toISOString() });
